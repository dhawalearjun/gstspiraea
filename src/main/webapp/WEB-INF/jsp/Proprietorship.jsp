        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        <form:form method="post" action="applyProprietorship" id="applicationFrm" name="applicationFrm" modelAttribute="ProprietorshipDetails">
                     <table>
                    <tr>
                    <td>    
            	<div class="col-md-3">
				...
				<tr>
				<td>
				<span id="ContentPlaceHolder1_Label1" class="manadatory">Proprietor's Father name</span>
				</td>
				<td><input name="propfather" type="text" maxlength="500" id="propfather" />
				</td>
				<td></td>
				<td></td>
				</tr>
				...
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Adhar Number of Proprietor</span></td>
				...
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Name of Authorised Signatory </span></td>
				<td><input name="authSignName" type="text" maxlength="200" id="authSignName" /></td>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Signatory's Father Name </span></td>
				<td><input name="signFatherName" type="text" maxlength="200" id="signFatherName" /></td>
				</tr>
				
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Adhar Number of Signatory</span></td>
				<td><input name="adharNumber" type="text" maxlength="50" id="adharNumber" /></td>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Signatory Adhar copy Attachment</span></td>
				<td>
				<input type="file" name="browsesignadhar" id="browsesignadhar" accept="image/*" >
				<!--  <input type="button" id="browsesignadhar" name="browsesignadhar" value="Browse" tabindex="4" class="btn btn-danger btn-sm" autocomplete="off">--></td>
				</tr>
				
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Residential Address of Signatory</span></td>
				<td><input name="signAddress" type="text" maxlength="50" id="signAddress" /></td>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Passport photo of Signatory Attachment</span></td>
				<td>
				<input type="file" name="browsesignphoto" id="browsesignphoto" accept="image/*" >
				<!-- <input type="button" id="browsesignphoto" name="browsignphoto" value="Browse" tabindex="4" class="btn btn-danger btn-sm" autocomplete="off"> --></td>
				</tr>
