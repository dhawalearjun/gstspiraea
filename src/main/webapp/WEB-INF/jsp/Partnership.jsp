        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <td>    
            	<div class="col-md-3">
                	<span id="ContentPlaceHolder1_Label1" class="manadatory">Name of Partnership Firm</span>
            	</div>
            	</td>
            	<td>
				...
				<tr>
				<td>
				<span id="ContentPlaceHolder1_Label1" class="manadatory">Number of partners</span>
				</td>
				...
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Partner Name</span></td>
				<td><input name="adharNumber" type="text" maxlength="50" id="adharNumber" /></td>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Partner Father Name</span></td>
				...
				<tr>
				<td><span id="ContentPlaceHolder1_Label1" class="manadatory">Adhar Number of Partner</span></td>
				<td><input name="adharNumber" type="text" maxlength="50" id="adharNumber" /></td>
