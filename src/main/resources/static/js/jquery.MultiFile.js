		    ...
		    MultiFile.addSlave = function (slave, slave_count) {
		        ...
		        slave.change(function () {
		            ...
		            if (MultiFile.accept && v && !v.match(MultiFile.rxAccept)) {
		                var test = MultiFile.STRING.denied.replace('$ext', String(v.match(/\.\w{1,4}$/gi)));
		                ERROR = test.replace('$accept', MultiFile.accept);
		                //ERROR = MultiFile.STRING.denied.replace('$accept', MultiFile.accept);
